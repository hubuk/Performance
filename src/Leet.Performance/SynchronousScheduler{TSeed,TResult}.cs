//-----------------------------------------------------------------------
// <copyright file="SynchronousScheduler{TSeed,TResult}.cs" company="Leet">
...
namespace Leet.Performance
{
    ...
    /// <summary>
    ///     Synchronously executes the performance scenario measurement.
    /// </summary>
    ...
    /// </typeparam>
    public class SynchronousScheduler<TSeed, TResult> : IMeasurementScheduler<TSeed, TResult>
    {
        /// <summary>
        ...
        /// </returns>
        public Task<MeasurementResult<TResult>> QueueMeasurement(PerformanceScenario<TSeed, TResult> scenario, MeasurementContext<TSeed> context, CancellationToken cancellationToken)
        {
            MeasurementResult<TResult> result;

            try
            {
                result = scenario(context, cancellationToken);
            }
            catch (Exception e)
            {
                var completionSource = new TaskCompletionSource<MeasurementResult<TResult>>();
